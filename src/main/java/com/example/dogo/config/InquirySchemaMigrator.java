...
@Component
public class InquirySchemaMigrator implements ApplicationRunner {
    ...
    public InquirySchemaMigrator(JdbcTemplate jdbcTemplate, DataSource dataSource) {
    ...
    public void migrate() throws SQLException {
        ...
        addColumnIfMissing("IS_PRIVATE", "IS_PRIVATE BOOLEAN NOT NULL DEFAULT TRUE");
    }
